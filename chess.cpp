...
void callBack(Interface *pUI, void * p)
{
   ...
   // move 
   if (gameBoard->move(board, pUI->getPreviousPosition(), pUI->getSelectPosition()))
      pUI->clearSelectPosition();
   else
      possible = gameBoard->getPossibleMoves(board, pUI->getSelectPosition());
...
int main(int argc, char** argv)
{
    ...
    ********************************/
    ...
    cout << "Ready to go! getpossible" << endl;
